...
try {
    ...
    let citySorted = book.sortByCity();
    book.showContacts(citySorted);

    console.log("\nContacts sorted by State:");
    let stateSorted = book.sortByState();
    book.showContacts(stateSorted);

    console.log("\nContacts sorted by Zip:");
    let zipSorted = book.sortByZip();
    book.showContacts(zipSorted);
